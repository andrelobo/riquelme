        ...
        <div className="flex flex-1 justify-center">
          <div className="w-full max-w-144">
            <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
              ...
              <div className="mb-6">
                <label className="block text-red-700 text-sm font-bold mb-2" htmlFor="authcode">
                  Authentication Code
                </label>
                <input
                onChange={this.onChange} name="authcode"
                className="shadow appearance-none border rounded w-full py-2 px-3 text-red-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="authcode" type="authcode" />
              </div>
